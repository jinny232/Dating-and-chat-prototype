...
if (isset($_SESSION['username'])) {
    ...
    function calculatePercentage($currentUser, $userData) {
        // Attributes to skip
        $skipAttributes = ['name', 'location', 'gender', 'age', 'p_p', 'img1', 'img2', 'img3'];
    ...
    <body>
        ...
        <div class="pre-container">
            ...
            foreach ($userData as $user) {
                // Check if the user's interest_in matches the current user's gendergender
                if($interestIn === "Both"){
